...
왜 수학에서 논리가 적용되야 하는가? 우리가 그렇게 다루니까.

그렇기 때문에 논리의 시작점인 공리에서, 두 연산의 동등을 포함한 등식을 이용한 논리; 공식에 대해 보장할 필요가 있다.

그렇게 공식만으로 대체 왜 수학이 공리로 이루어져야 하는가를, 부울 대수나 집합론같은 거추장스러운것 없이 서술하는 방법으로, CSFB대수를 만들었다.