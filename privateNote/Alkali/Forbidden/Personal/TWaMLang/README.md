...
| 문자 | 로마자 |
| 목적 | TWaML("수리논리로 말하기"의 준말임) (그니까 왜 TWaML목적으로 쓸 말이 있어야 하냐고 : 의외성정리([명시된 문서는 이 링크에](https://faraway6834.github.io/unbeauty/privateNote/Alkali/Forbidden/Personal/Abstract))에서 말하는 단순의미언어중 쉬운거 제작헤서 대화하면 단순한 형식언어 가지고 채계적이고 심플하며 쉽게 대화가능하기에.) |
