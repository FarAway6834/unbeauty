...
흠...? 분할복소수 j에 대해서, 범자연수 x, y가 있으면, x + jy라고 대수적으로 표현 가능하잖아? Jesus Christ! 이래서 내가 이 모델이 쌈@@뽕하다 한거라고, 아름다워!

유리수는 체감상 만들기 쉬워서, 개인정으로 정수환을 만들고 싶었음.

근데 마침 정수환을 만들었어서 쥰@@내 쌈@@뽕하다 느낀거임

아래 항목은 별로 중요하지도 않음.

아래 항목은 전혀 (전혀 스윙을 하고있지 않은게 아니라, )「표현론」을 하고있지 않아 

### 예전에 허접한 두뇌로 만든 전혀 even하지도 쌈@@뽕하지도 않은, 쉬워 빠진 허접 시스템
