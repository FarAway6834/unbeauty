...
Note : KyuKurarin구현 이전엔 perl로 구현된 저속 인터프리터로, KyuKurarin PCRE를 돌린다. KyuKurarin은 구현 초기부터, KyuKurarin PCRE로 짜였으니, 초기에만, Perl KyuKurarin PCRE interpreter를 Blotstrap용으로 쓰지, 나중엔, KyuKurarin PCRE는 AOT언어다.
