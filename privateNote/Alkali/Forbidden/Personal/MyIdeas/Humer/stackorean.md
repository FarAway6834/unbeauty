...
문법에서 타입 배제주의 : 타입이론은 수학이지 자연어가 아니다. 플라톤주의적인 기괴한 망상증이다. (이 입장도 극단적으로 형식주의적이지. 동형성이 있을순 있으나, 함수와 선형사상이 사상일뿐 실제로는 (X, Y, graph f)와 행렬표현으로 엄연히 다르듯, 타입이론과 수학이 같다는건, HoTT를 긍정하는 급의 병적인 망상이라는건, 나는 철회할 생각이 없어. 내 입장에선 이건 음모론이 아니야. 형식주의적 펙트야.)
