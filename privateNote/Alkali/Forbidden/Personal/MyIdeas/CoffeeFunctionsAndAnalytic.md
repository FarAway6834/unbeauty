...
DizzyFact<X, Y> : ∀smooth<X, Y>(f), ∃S ∈ getAnalyticDomains<X, Y>(f)

 -> 오 시바... DizzyFact<X, Y>가 참이란다 우헤헤, 모든 매끄러운 함수는 해석적 정의역을 가진다.

엥? C^∞랑 해석함수랑 차이가 있다면, 정의역이 해석적 정의역인가 아닌가로 나뉠 뿐인 메끄러운 함수네?