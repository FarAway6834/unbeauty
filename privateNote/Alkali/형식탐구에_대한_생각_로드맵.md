...
### 형식 탐구론은 형식주의 근본주의적 극단주의 철학사조가 형식탐구임을 인정한다. 앎에 대한 밥벌이를 위한 극단적인 지식에 대한 갈망으로써 LCPC체계를 제안한다. (궁극적, 핵심내용, **이 글에서 가장 핵심**) 근데 영어 : [LCPC](https://faraway6834.github.io/unbeauty/privateNote/Alkali/LCPC)
```
