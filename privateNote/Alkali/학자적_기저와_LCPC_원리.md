 (+) Edit; 2025 Jul 22th이후로 2025 Nov 7에 수정하는데, 이 글은 의도는 좋지만 자기비판을 혐오하는 미칰 나르시스트의 방어기제가 다량 포함된 쓰래기다. LCPC는 Alkalic과 철학적인 서술을 통해서 만물을 환원하려는 환원주의라고 까도 좋을것 같다. 사실 Alkalic보다 철학이 차지하는 비중이 큰게 Alkalic은 고작 형식화 가능한것만 다룰수 있기 때문이다. 걍 이건 순수한 학문을 탐구하려는 학자적 기저를 생기로 두는 미학일 뿐이지, 결국 근본적인 문제는 해결 못한것이다.
...
어떤 멍청한 AI에게 어떻게 보이냐고 물어봤더니, 철학을 과학으로 다룬다고 지랄하는데...

철학은 그 내용의 정이에 synurl을 쓰는건 걍, 문자열 대 문자열 매칭이므로, 사실상 synurl말고도 콜론 (:)을 이용하여, 간결히 정의할수 있소 그게 좆같지 않고 좋고 권장될필요가 존나 높다.

철학은 또한 탐구가 씨발 어떻게 형식논리로만 되나? 그게 탐구의 전부가 아닌데, LCPC는 그런 등신이 아니다, 단지 최적의 탐구법과 사실만 쫒는 과학과 학계와 탐구와 학자적 동기라는 전체주의나 극단주의임을 인정하고, 그 학문과 탐구라는 사념(이념적인 특성은 밈이라 그럼)을 목적대로 탐구하겠다는 건데, 자신의 한계를 밝히는것은 중요하다.

마지막으로, 수학 언어로 사고하는 수학과는 달리, 경험 탐구가 아닌 연역적 탐구의 갈래로써 수학, 철학 중 철학은, 본래 탐구 목적에 대한 검증이 invalid여도, 본문에는 본래 아이디어가 틀렸는데, 실제로 이론을 만드는 과정에서, 정답을 창조한것이기 때문에, 수정할 필요가 없다.

따라서, 이러한 철학에 대해서 예외적으로 과학적으로 무결하지 않아도, 애초에 반증가능성 보존 목적이 아닌 철학은, 그 탐구 흐름 및 생각의 허점을 찌르는 건설적인 행위를 위한 기록이 귀찮게 들어가는거지, 에초에 다룰수 없을만한걸 등신처럼 다루겠다는게 아니다.

그런걸 할려 했다면 진짜 등신이지.

 + 이 체계는 자기서술을 피하는데, 이는 자기서술이란것은 근본적으로 엄밀함따위가 동반될수 없기 때문이다. 그 이상한 AI는 왜 이게 자기서술이라고 생각할까?

---

2025 Nov추가 수정사항이다. 나는 요즘 바보같은 흑역사를 후회중이다.

위에 저 자기서술이라는 말을 보면 지능인증이 보인다. 2025.7.22일에는 자기자신이라는 주사가 나오면 자기서술이 되는지 모르는 단어를 모르고 사용하는 행태를 보인다.

아 뒷꼴아파 저 멍청이...

추가적으로 말하고자 하는바는 참고사항좀 첨부하겠다는거 ;;

# [LinearUnbeauty & Labare & Unbare & Edgar](https://faraway6834.github.io/unbeauty/privateNote/Proof/LinearUnbeauty%26Labare%26Unbare%26Edgar)
...
그런데 Edgar는 당연히 흐름은 이해할거라고 가정하고 설명을 진행하고있다.
...
암튼 최근 개발한 언어가 그나마 보여줄만한 애들이 있는것 같고,

뭐.... 사실 모듈화의 미덕으로 기능적으로도 모양으로도 유지보수로도 구조로도 성능으로도 아름다운 코드를 강박적으로 지향햤던개 껍대기만 남은것으로,

형식 언어를 만드는데 빠졌고, Alkalic을 만듬으로써, 결실을 맺은것 같다.

그러니 거기 쓰이는 정도로만 만족하자고.

하... 씹... 과거의 나 역겨워, 근데 사고기제가 바뀌니까 내가 아니라 걍 죽일놈같고... 기억하는 자아가 나라니...
...
# 위의 Alkalic + Lava와 아래의 infos는 내가 5달동안 전부 혼자 탐구한 뻘짓들이다.
